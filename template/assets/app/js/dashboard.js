...
/*END COMMON */
    ...
    $('#socialform').validate({
        ...
        errorClass: 'help-block offset-md-3', // default input error message class
        ...
        highlight: function (element) { // hightlight error inputs
            $(element).closest('.form-group').siblings('.help-block').remove();
    ...
    $('#portlet-config_social_media').on('show.bs.modal', function () {
        $("#portlet-config_social_media .help-block").remove();
        $("#portlet-config_social_media .form-group").removeClass('has-error');
      })
        ...
        $.post('API/update_candidate_info.php',{
            ...
            function(data){
                if (data==1){
                    ...
                    $("#facebooklink .m-nav__link-text").text(facebook);
                    $("#twitterlink").attr("href",twitter);
                    $("#twitterlink .m-nav__link-text").text(twitter);
                    $("#linkedinlink").attr("href",linkedin);
                    $("#linkedinlink .m-nav__link-text").text(linkedin);
...
$('#portlet-config_work_experience').on('show.bs.modal', function () {
    $("#portlet-config_work_experience .help-block").remove();
    $("#portlet-config_work_experience .form-group").removeClass('has-error');
  })
...
$('#portlet-config_education').on('show.bs.modal', function () {
    $("#portlet-config_education .help-block").remove();
    $("#portlet-config_education .form-group").removeClass('has-error');
  })
